...
#ifdef TP8UE4_MonActeur_generated_h
#error "MonActeur.generated.h already included, missing '#pragma once' in MonActeur.h"
#endif
...
public: \
	DECLARE_CLASS(AMonActeur, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/TP8UE4"), NO_API) \
...
#define TP8UE4_Source_TP8UE4_MonActeur_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AMonActeur); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AMonActeur); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AMonActeur(AMonActeur&&); \
	NO_API AMonActeur(const AMonActeur&); \
public:
...
template<> TP8UE4_API UClass* StaticClass<class AMonActeur>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID TP8UE4_Source_TP8UE4_MonActeur_h
